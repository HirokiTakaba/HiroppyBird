 ...
 */
    ...
    public:
        ...
        MemoryPoolAllocator(size_t chunkSize=kDefaultChunkCapacity, BaseAllocator* baseAllocator=0)
            ...
            , ownBaseAllocator_(0)
        {
            if (!baseAllocator_) ownBaseAllocator_ = baseAllocator_ = new BaseAllocator();
        ...
        void* Malloc(size_t size)
        {
            ...
            if (chunkHead_->size + size > chunkHead_->capacity) AddChunk(chunk_capacity_ > size?chunk_capacity_:size);
 ...
 */
    ...
    struct UTF8
    {
        ...
        static Ch* Encode(Ch* buffer, unsigned codepoint)
        {
            if (codepoint <= 0x7F) *buffer++ = codepoint & 0xFF;
 ...
 */
    ...
    struct GenericStringStream
    {
        ...
        GenericStringStream(const Ch* src): src_(src)
            , head_(src) {}
 ...
 */
    ...
    struct GenericInsituStringStream
    {
        ...
        GenericInsituStringStream(Ch* src): src_(src)
            , dst_(0)
            , head_(src) {}
